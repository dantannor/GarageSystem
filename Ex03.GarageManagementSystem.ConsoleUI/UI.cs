    ...
    */
    ...
    public class UI
    {
        ...
        private void RefuelVehicle()
        {
            ...
            if (carInGarage)
            {
                eFuelType fuelType = (eFuelType)View.MenuScan(
@"Choose fuelType:
 1. Solar,
 2. Octan95,
 3. Octan96,
 4. Octan98",
        ...
        private void UpdateVehicleStatus()
        {
            ...
            if (carInGarage)
            {
                eVehicleStatus statusToChange = (eVehicleStatus)View.MenuScan(
@"Car status:
...
3. Paid",
        ...
        {
            int choose = View.MenuScan(
@"Show licenses ID by Status?
1. Yes
2. NO",
      2);
            ...
            if (choose == 1)
            {
                eVehicleStatus status = (eVehicleStatus)View.MenuScan(
@"Car status:
...
3. Paid",
        ...
        private void AddVehicle()
        {
            ...
            else
            {
                ...
                eVehicleType vehicleType = (eVehicleType)View.MenuScan(
@"Vehicle Type:
         ...
         5);
                ...
                switch (vehicleType)
                {
                    ...
                    case eVehicleType.GasCar:
                        eColor color = (eColor)View.MenuScan(
@"Choose car's color: 
1. Green
2. Black
3. White
4. Red",
       4);
                        ...
                        eNumOfDoors doors = (eNumOfDoors)View.MenuScan(
@"Choose car's number of doors:
1. Two
2. Three
3. Four
4. Five",
        4);
                    ...
                    case eVehicleType.GasMotorcycle:
                        eLicenseType licenseType = (eLicenseType)View.MenuScan(
@"Choose mtorcycle's licenseType:
1. A
2. A2
3. AB
4. B1",
